...
val SAMPLE_DATA_INVERTED = arrayOf(
...
fun <T> Cluster<T>.getPanel(label: String = "Cluster", scaleInterval: Double = 0.1, precision: Int = 2): DendrogramPanel<T> =
        with(DendrogramPanel<T>()) {
            add(Label(label))
            isShowScale = true
